...
function AccountChatMessage ({chatMessage, addChatMessage}: {chatMessage: ChatMessage,
     addChatMessage: (bayer_id: number, myService_id: number, text: string) => void}): JSX.Element {
...
const [text, setText] = useState('');
 ...
 console.log(chatMessage)
    ...
    return (
        <div>
     {user && chatMessage && chatMessage.User.id && user.id  === chatMessage.User.id ?
